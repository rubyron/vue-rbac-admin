<template>
  <div class="ops-board">
    ...
    <el-row :gutter="12" class="mb-12">
      <el-col :span="16">
        <BaseChart title="工单趋势（新建/已解决/逾期）" :option="optTrend" :loading="loading" :empty="emptyTrend" height="320px">
          <template #extra>
      ...
      <el-col :span="8">
        <BaseChart title="状态分布" :option="optStatusPie" :loading="loading" :empty="emptyStatus" height="320px" @chartClick="onStatusClick">
          <template #extra>
    ...
    <el-row :gutter="12" class="mb-12">
      <el-col :span="8">
        <BaseChart title="渠道来源" :option="optChannelBar" :loading="loading" :empty="emptyChannel" height="280px" @chartClick="onChannelClick">
          <template #extra>
            <span class="extra-hint">点击下钻</span>
          </template>
        </BaseChart>
      ...
      <el-col :span="8">
        <BaseChart title="SLA 合规率（本月）" :option="optSlaGauge" :loading="loading" :empty="emptySla" height="280px">
          <template #extra>
      ...
      <el-col :span="8">
        <BaseChart title="优先级平均解决时长（小时）" :option="optPriority" :loading="loading" :empty="emptyPriority" height="280px" />
      </el-col>
    </el-row>

    <el-row :gutter="12">
      <el-col :span="24">
        <BaseChart title="团队负载（待处理/处理中/逾期）" :option="optTeam" :loading="loading" :empty="emptyTeam" height="320px" @chartClick="onTeamClick">
          <template #extra>
...
import { trendOption, statusPieOption, channelBarOption, slaGaugeOption, priorityTtrOption, teamLoadOption } from '../options'
